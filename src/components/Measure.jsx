    ...
    <Container>
      ...
      <Box sx={{ marginTop: "2rem", marginBottom: "2rem" }}>
        <Box display="flex" justifyContent="right" mb={2}>
          <IconButton href="https://facebook.com" style={{ color: "#3b5998" }}>
            <Facebook />
          </IconButton>
          <IconButton href="https://twitter.com" style={{ color: "#00acee" }}>
            <Twitter />
          </IconButton>
          <IconButton href="https://linkedin.com" style={{ color: "#0e76a8" }}>
            <LinkedIn />
          </IconButton>
          <IconButton href="https://pinterest.com" style={{ color: "#c8232c" }}>
            <Pinterest />
          </IconButton>
          <IconButton href="https://instagram.com" style={{ color: "#E1306C" }}>
            <Instagram />
          </IconButton>
        </Box>
        <Typography variant="h6" gutterBottom fontWeight="bold">
          Diamond Shop will guide you on how to measure your ring size at home
          and secretly measure a ring to surprise your loved one, especially for
          those special moments in life. With the tips in this article, you can
          easily shop for gold rings, silver rings, wedding rings, diamond
          rings, or couple rings online without any worries.
        </Typography>
      </Box>
      <Paper
        elevation={3}
      ...
      >
        <List component="nav">
          <ListItem>
            <Link href="#section1" underline="none" sx={{ color: "#000000" }}>
              <ListItemText primary="Diamond Shop ring size chart" />
            </Link>
          </ListItem>
          <ListItem>
            <Link href="#section2" underline="none" sx={{ color: "#000000" }}>
              <ListItemText primary="The simplest ways to measure ring size" />
            </Link>
          </ListItem>
          <ListItem>
            <Link href="#section3" underline="none" sx={{ color: "#000000" }}>
              <ListItemText primary="Notes when measuring" />
            </Link>
          </ListItem>
          <ListItem>
            <Link href="#section4" underline="none" sx={{ color: "#000000" }}>
      ...
      >
        <Box id="section1">
          <Typography variant="h5" gutterBottom fontWeight="bold">
            Diamond Shop ring size chart
          </Typography>
          <Typography variant="body1" gutterBottom>
            Diamond Shop women’s ring sizes range from size 4.5 – 8.5. Diamond
            Shop men’s ring sizes range from size 9 – 13.5.
          </Typography>
          <img
        ...
        <Box id="section2">
          ...
          <Typography variant="body1" gutterBottom>
            Step 5: Remove and measure the length of the paper from the starting
            point to the marked point. Divide the measurement by 3.14. Then
        ...
        <Box id="section3">
          ...
          <Typography variant="body1" gutterBottom>
            The thickness of the ring also affects each person’s ring size. For
            rings like gold rings, silver rings, especially Diamond Shop wedding
            rings, the thickness varies. Therefore, when measuring, you need to
            pay attention and adjust the size to ensure the ring is comfortable
            to wear.
          </Typography>
          <img
          ...
          <Typography variant="body1" gutterBottom>
            ...
            the right ring size. This way, the ring will be comfortable and not
            cause discomfort when bending the finger.
          </Typography>
          <img
          ...
          <Typography variant="body1" gutterBottom>
            There may be errors when measuring finger size, so carefully measure
            3-4 times to find the most accurate measurement. This method will
            give you a measurement accuracy of 85-95%.
          </Typography>
          <Typography variant="body1" gutterBottom fontWeight="bold">
        ...
        <Box id="section4">
          ...
          <Typography variant="body1" gutterBottom>
            ...
            (regular, fashion, or couple rings), then use a ruler to measure the
            inner circumference as instructed above.
          </Typography>
          <Typography variant="body1" gutterBottom fontWeight="bold">
            Asking for help from family members
          </Typography>
          <Typography variant="body1" gutterBottom>
            The simplest way to find out your loved one’s ring size without her
            noticing or suspecting is to ask for help from family members, like
            her mother, sisters, or friends. They can naturally get this
          ...
          <Typography variant="body1" gutterBottom>
            ...
            you can estimate the ring size based on height and weight according
            to the chart below:
          </Typography>
          <img
          ...
          <Typography variant="body1" gutterBottom>
            In this way, you need to skillfully ask her to try on a ring, maybe
            a fashion ring or a gold ring you want to buy for your mother or
            sister. Meanwhile, pay attention to her finger size so you can
            easily buy a matching couple ring or wedding ring.
          </Typography>
          <img
          ...
          <Typography variant="body1" gutterBottom>
            Compare your finger with hers: Observe carefully the joints and base
            of her finger compared to yours to find the most accurate ring size.
          </Typography>
          <br/>
          <Typography variant="body1" gutterBottom >
            <strong>What if the ring doesn’t fit?</strong> Don’t worry! Diamond Shop offers free
            product exchange within 48 hours. Feel free to shop and experience
            the best customer service at Diamond Shop!
          </Typography>
        </Box>
      </Box>
